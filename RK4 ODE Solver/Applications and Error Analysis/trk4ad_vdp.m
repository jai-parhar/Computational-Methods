...
title("Van der Pol Oscillator Position vs Time (rk4ad)");
grid on;
...
title("VDP Oscillator Phase-Space Velocity vs Position (rk4ad)",'Interpreter','latex');
grid on;
